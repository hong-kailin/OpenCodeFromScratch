...
interface Props {
  ...
  /**
   * Optional GitHub link pinned to the right end of the bar.
...
/**
 * Always-on progress bar docked to the TOP of the viewport, overlaying the
 * full-bleed stage. Click a chapter pill or pip to jump.
 *
 * It never hides: it is part of the recorded frame (it shows the viewer
 * where they are in the deck), not dev-only chrome. See ProgressBar.css
 * for why it overlays rather than displaces the stage, and base.css for
 * the --chrome-* color tokens that keep it readable on every theme.
 *
 * Width is content-adaptive and capped at `100vw - 64px`; if total chapters
 ...
 * on chapter change so it is always on screen.
 */
