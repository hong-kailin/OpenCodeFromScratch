...
- **课程文档**：每节课在 docs/ 下创建编号文件夹，如 docs/01-minimal-agent/
...
- 每节课涉及多个概念时，拆成多个 .md 文件而非一个超长 README，每个文件聚焦一个独立知识点
- 按序号编号：如 01-bun-basics.md、02-typescript-types.md、03-fetch-llm.md
- README.md 只做目录导航，不承载正文
- 判断拆分时机：一个 README 超过约 150 行，或出现明显话题切换时就拆
